...
### Step 6: Update HTML Pages with Notion Links

Once you have the `notion-page-urls.json` file created by Step 4, run this script to automatically add Notion links to all HTML modules:

```bash
# Make script executable
chmod +x update-html-with-notion.py
...
============================================================
Update complete! All HTML files now link to Notion pages.
============================================================
```

**What This Does:**
- Reads `notion-page-urls.json` generated by notion-sync.py
- Adds a "View in Notion" card to each HTML module's Resources section
- Links directly to the corresponding Notion page
- Skips modules that already have Notion links (idempotent)
...
| `update-html-with-notion.py` | Adds Notion page links to HTML modules |
| `requirements.txt` | Python dependencies |
| `.env.example` | Template for API credentials |
| `.env` | **Your actual credentials (gitignored)** |
| `notion-page-urls.json` | Saved Notion page URLs (generated by notion-sync.py) |
...
- [ ] Ran `python3 update-html-with-notion.py` to add Notion links to HTML
- [ ] Verified Notion links appear in HTML modules
- [ ] Tested markdown viewer in browser
- [ ] Committed and deployed changes to Netlify
